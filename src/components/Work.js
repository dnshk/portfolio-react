      ...
      <div className="col-md-4">
        <div className="work-box">
          <a href="assets/img/work-3.jpg" data-gallery="portfolioGallery" className="portfolio-lightbox">
            <div className="work-img">
              <img src="assets/img/work-3 - Copy.jpg" alt="" className="img-fluid" />
            </div>
          </a>
          <div className="work-content">
            <div className="row">
              <div className="col-sm-8">
                <h2 className="w-title">Activity Tracking Mobile Application</h2>
                <div className="w-more">
                  <span className="w-ctegory">Mobile Development</span> / <span className="w-date">Dec, 2020</span>
                </div>
              </div>
              <div className="col-sm-4">
                <div className="w-like">
                  <a href="portfolio-details-5.html"> <span className="bi bi-plus-circle" /></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="col-md-4">
        <div className="work-box">
          ...
          <div className="work-content">
            <div className="row">
              <div className="col-sm-8">
                <h2 className="w-title"><b>Unnamed Project  Coming Soon!</b></h2>
                <div className="w-more">
                  <span className="w-ctegory">Web Design</span> / <span className="w-date"> Jul, 2021</span>
                </div>
              </div>
              <div className="col-sm-4">
                <div className="w-like">
                  {/* <a href="portfolio-details-6.html"> <span class="bi bi-plus-circle"></span></a> */}
                </div>
              </div>
            </div>
          </div>
